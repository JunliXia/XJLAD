...
//	alert(1);
	$(".group-listclient").html("");
	$(".group-listclient").append('<div class="group-one" style="height:100%;background-color: rgb(248,254,254);"> '+
			'<div class="group-title" ><img src="./pic/back.png" style="height:30px;width:20px;cursor: pointer;margin-left:-980px;" onclick="showback()"></img><div style="margin-top:-25px;"><font>增加客户</font></div></div>'+
